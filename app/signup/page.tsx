...
export default function SignupPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] px-4 relative overflow-hidden py-12">
      ...
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[650px] h-[550px] bg-gradient-to-tr from-indigo-300/30 to-purple-300/20 blur-[130px] -z-10 pointer-events-none rounded-full" />
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-xl shadow-slate-900/5 border border-slate-200/80 p-8">
          ...
          <p className="text-xs text-slate-500 mb-6">
            Get started with unified payment ingestion and automated reconciliation
          </p>
          ...
          <div className="mt-4 pt-4 border-t border-slate-100 text-center">
            ...
            >
              ...
              <span>Explore Demo Dashboard without Signup</span>
            </button>
          </div>
